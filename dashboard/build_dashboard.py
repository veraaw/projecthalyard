"""Build dashboard/index.html: one page summarising the scoping (Slack thread) findings,
the verification (CSV profile) findings, and the intro funnel Sankey.
...
<header>
  ...
  <nav style="margin-top:12px"><a href="#funnel">Funnel</a><a href="#scoping">Scoping: Slack threads</a><a href="#verify">Verification: CSV profile</a></nav>
</header>
<main>
