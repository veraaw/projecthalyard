...
```
   ...
   2025-12-20  intro_requests.csv   Nadia Okonkwo        R1073 raised by Nadia Okonkwo (AE, Industrials): wants Chief Information Officer, $80,000, Low urgency, filed "Closed - no path"
...
4 people from investor_network.csv, 0 askable as investor_network paths, 4 with no warm path; a view of section 3 and the roster's exports, nothing here is scored or allocated on its own
