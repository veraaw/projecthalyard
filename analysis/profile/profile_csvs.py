"""Column-level inventory profile of every CSV in dataset/.

Writes analysis/profile/profile.md. Uses the csv module so quoted fields
containing commas parse correctly.

    python3 -m analysis.profile.profile_csvs      # from the repo root
"""
...
def main():
    ...
    out.append(
        "Generated by `analysis/profile/profile_csvs.py` (stdlib `csv`, so quoted fields containing commas "
